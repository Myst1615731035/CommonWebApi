...
{
    /// <summary>
    /// RolePermissionButtonController
    /// </summary>	
    [Route("api/[controller]/[action]")]
    [ApiController]
    [Authorize]
    public class RolePermissionButtonController : ControllerBase
    {
        #region 接口构造
        private readonly IRolePermissionButtonServices _service;
        private readonly IUser _user;
        private readonly ILogger<RolePermissionButtonController> _logger;
        ...
        public RolePermissionButtonController(IRolePermissionButtonServices service, IUser user, ILogger<RolePermissionButtonController> logger)
        {
            _service = service;
            _user = user;
            _logger = logger;
        ...
        {
            var exp = Expressionable.Create<RolePermissionButton>();
            // 增加查询条件
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ContentJson<string>> SaveEntity([FromBody] RolePermissionButton entity)
        {
            //结果定义
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ContentJson<string>> Delete([FromBody] RolePermissionButton entity)
        {
            //结果定义
            var result = new ContentJson<string>()
            {
